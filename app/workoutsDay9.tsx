  ...
  return (
    <View style={styles.viewCont}>
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.dayText}>Day 9</Text>
      ...
      <View style={styles.infoBox}>
        ...
        <View style={styles.infoItem}>
          <Text style={styles.infoNumber}>15 min</Text>
          <Text>Time</Text>
        </View>
        <View style={styles.infoItem}>
          <Text style={styles.infoNumber}>165 kcal</Text>
          <Text>Calories</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.exerciseBox}>
        ...
        <View style={styles.exerciseItem}>
          <Text>🔥 BEAR CRAWL SHOULDER TAP</Text>
          <Text>00:20</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>💪 WIDE GRIP PUSH UPS</Text>
          <Text>x 15</Text>
        </View>
        ...
        <View style={styles.exerciseItem}>
          <Text>🔥 TOES TO BAR (Modified)</Text>
          <Text>x 20</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>🤸 SQUAT TO CALF RAISE</Text>
          <Text>x 20</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>💥 SUPERMAN PULSES</Text>
          <Text>00:30</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>🤾 FAST FEET TAP</Text>
          <Text>00:25</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>🧘 CHILD'S POSE STRETCH</Text>
          <Text>00:30</Text>
        </View>
        ...
        <View style={styles.exerciseItem}>
          <Text>💥 BRIDGE HIP LIFTS</Text>
          <Text>x 18</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>🦵 STEP UPS (On Chair)</Text>
          <Text>x 16 each leg</Text>
        </View>
