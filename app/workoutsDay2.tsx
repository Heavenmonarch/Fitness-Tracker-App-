  ...
  return (
    <View style={styles.viewCont}>
      ...
      <View style={styles.infoBox}>
        ...
        <View style={styles.infoItem}>
          <Text style={styles.infoNumber}>10 min</Text>
          <Text>Time</Text>
        </View>
        <View style={styles.infoItem}>
          <Text style={styles.infoNumber}>123.9 kcal</Text>
          <Text>Calories</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.exerciseBox}>
        ...
        <View style={styles.exerciseItem}>
          <Text>🏃‍♂️ JUMPING JACKS</Text>
          <Text>00:20</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>💪 CROSS ARM CRUNCHES</Text>
          <Text>x 12</Text>
        </View>
        ...
        <View style={styles.exerciseItem}>
          <Text>🏋️‍♂️ PUSH UPS</Text>
          <Text>x 10</Text>
        </View>

        <View style={styles.exerciseItem}>
          <Text>🤸‍♂️ MOUNTAIN CLIMBERS</Text>
          <Text>00:20</Text>
        </View>
